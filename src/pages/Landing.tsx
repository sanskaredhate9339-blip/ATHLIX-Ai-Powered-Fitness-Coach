...
export const Landing: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#09090E] text-slate-100 overflow-x-hidden selection:bg-primary selection:text-white">
      {/* Header */}
      ...
      {/* Mobile Menu Panel */}
      {mobileMenuOpen && (
        <div className="fixed inset-0 top-16 z-40 bg-[#09090E]/95 backdrop-blur-lg flex flex-col p-6 gap-6 md:hidden">
          <a href="#features" onClick={() => setMobileMenuOpen(false)} className="text-lg text-slate-300">Features</a>
          <a href="#how-it-works" onClick={() => setMobileMenuOpen(false)} className="text-lg text-slate-300">How It Works</a>
          <a href="#pricing" onClick={() => setMobileMenuOpen(false)} className="text-lg text-slate-300">Pricing</a>
          <a href="#faq" onClick={() => setMobileMenuOpen(false)} className="text-lg text-slate-300">FAQ</a>
      ...
      <section className="relative pt-32 pb-20 md:pt-44 md:pb-32 px-6 flex flex-col items-center text-center overflow-hidden">
        ...
        <motion.div 
          ...
          className="max-w-4xl"
        >
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10 text-xs font-semibold text-primary-light mb-6 shadow-glow">
            <Sparkles className="w-3.5 h-3.5" /> Next Generation AI Fitness Coaching PWA
          </div>
          <h1 className="font-heading font-extrabold text-4xl sm:text-6xl md:text-7.5xl leading-tight tracking-tight text-white mb-6">
          ...
          <p className="text-base sm:text-xl text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed font-sans">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            ...
            <a href="#features" className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-white/5 hover:bg-white/10 border border-white/10 text-base font-bold transition-all text-slate-300 hover:text-white text-center">
              Explore Features
            </a>
          </div>
        </motion.div>
      ...
      {/* How It Works */}
      <section id="how-it-works" className="py-20 md:py-28 bg-[#0C0C14] border-y border-white/5 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="font-heading font-bold text-xl text-white mb-3">Create Profile</h3>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="font-heading font-bold text-xl text-white mb-3">Generate Plan</h3>
              <p className="text-sm text-slate-400 max-w-xs leading-relaxed">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="font-heading font-bold text-xl text-white mb-3">Execute & Analyze</h3>
              <p className="text-sm text-slate-400 max-w-xs leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="glass-panel p-8 rounded-3xl">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h4 className="font-heading font-semibold text-sm text-white">David K.</h4>
                <span className="text-xs text-slate-500">Amateur Powerlifter</span>
              </div>
            </div>
          </div>
          ...
          <div className="glass-panel p-8 rounded-3xl">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h4 className="font-heading font-semibold text-sm text-white">Sarah T.</h4>
                <span className="text-xs text-slate-500">Crossfit Enthusiast</span>
              </div>
            </div>
          </div>
          ...
          <div className="glass-panel p-8 rounded-3xl">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h4 className="font-heading font-semibold text-sm text-white">Marcus L.</h4>
                <span className="text-xs text-slate-500">Calisthenics Athlete</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Pricing */}
      <section id="pricing" className="py-20 md:py-28 bg-[#0C0C14] px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="font-heading font-extrabold text-3xl sm:text-5xl text-white mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="glass-panel p-8 rounded-3xl flex flex-col justify-between">
              <div>
                <h3 className="font-heading font-extrabold text-lg text-slate-400 uppercase tracking-wider mb-2">Free</h3>
                <div className="text-3xl font-heading font-extrabold text-white mb-6">$0</div>
                <ul className="text-sm text-slate-400 flex flex-col gap-3.5 mb-8">
              ...
              <Link to="/register" className="py-3 rounded-2xl border border-white/10 hover:bg-white/5 text-center text-sm font-semibold transition-all">
                Get Started
              </Link>
            </div>
            ...
            <div className="glass-panel p-8 rounded-3xl border-primary/50 relative overflow-hidden flex flex-col justify-between shadow-premium">
              ...
              <div>
                ...
                <div className="text-3xl font-heading font-extrabold text-white mb-6">$9.99<span className="text-sm text-slate-500 font-normal">/mo</span></div>
            ...
            <div className="glass-panel p-8 rounded-3xl flex flex-col justify-between">
              <div>
                <h3 className="font-heading font-extrabold text-lg text-slate-400 uppercase tracking-wider mb-2">Elite</h3>
                <div className="text-3xl font-heading font-extrabold text-white mb-6">$29.99<span className="text-sm text-slate-500 font-normal">/mo</span></div>
                <ul className="text-sm text-slate-400 flex flex-col gap-3.5 mb-8">
            ...
            return (
              ...
              >
                <button
                  ...
                  className="w-full px-6 py-5 flex items-center justify-between text-left font-heading font-bold text-base text-white hover:text-primary-light transition-colors"
                >
                  <span>{faq.q}</span>
                  <ChevronDown className={`w-5 h-5 text-slate-400 transition-transform duration-300 ${isOpen ? 'rotate-180' : ''}`} />
                </button>
                {isOpen && (
                  <div className="px-6 pb-6 text-sm text-slate-400 leading-relaxed font-sans">
                    {faq.a}
                  </div>
                )}
              </div>
      ...
      {/* Footer */}
      <footer className="border-t border-white/5 py-12 px-6 bg-[#07070B] text-center text-sm text-slate-500 font-sans">
